...
export default function ComingAppDetail() {
  ...
  console.log("Raxmat yaxshi oziz qalesiz 💕");
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-md-light bg-white dark:bg-slate-950/60 backdrop-blur-sm overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                ...
                <Button className="bg-red-600 hover:bg-red-700 text-white w-full h-10 font-semibold text-base flex items-center gap-2 justify-center">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Majburiy amal</DialogTitle>
            <DialogDescription>
              Agar siz parolingiz yozib arizani qabul qilishini tastiqlamasangiz
              u qabul qilinmaydi. Iltimos parolingiz yozing!
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="mt-6 flex justify-end gap-2">
            <Button
              ...
              onClick={ArizaQabuliLoading ? LoadingAriza : addArizaQabuli}
            >
              {ArizaQabuliLoading ? (
